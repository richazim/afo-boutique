            ...
            <div class="header-wrap flex justify-between items-center">
                ...
                <div class="search-style-1 flex-grow px-20">
                    <form action="{{ route('home') }}" class="w-100">
                        <input id="search" name="search" type="text" placeholder="Rechercher un produit, une catégorie, une marque..." />
                    </form>
                </div>
                <div class="header-action-right">
                    <div class="header-action-2">
                        @auth
                            <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                                <nav class="">
                                    <ul class="">
                                        <li>
                                            <h1 class="text-black font-bold text-[1rem]">Bonjour, {{ Auth::user()->name }}</h1>
                                        </li>
                                        <li><a href="#">Mon compte<i class="fi-rs-angle-down"></i></a>
                                            <ul class="sub-menu">
                                                @if (Auth::user()->is_admin)
                                                    <li><a href="/admin">Tableau de bord admin</a></li>
                                                @endif
                                                <li><a href="{{ route('dashboard') }}">Tableau de bord des commandes</a></li>
                                                <li><a href="{{ route('profile.edit') }}">Paramètres du compte</a></li>
                                                <li>
                        ...
                        @else
                            <a href="{{ route('login') }}" class="pr-4 text-md font-semibold ">Se connecter</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="btn btn-sm btn-default">S'inscrire</a>
                            @endif
                        @endauth
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2 border-gray-200">
                                ...
                                <div class="shopping-cart-footer">
                                    ...
                                    <div class="shopping-cart-button">
                                        <a href="{{ route('cart') }}" class="btn btn-sm btn-secondary">Voir le panier</a>
                                        <a href="{{ route('checkout') }}" class="btn btn-sm">Commander</a>
                                    </div>
                                </div>
                            </div>
                        </div>
