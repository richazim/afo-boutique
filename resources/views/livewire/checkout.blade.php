    ...
    <section class="mt-50 mb-50">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-25">
                        <h4 class="font-semibold text-lg text-gray-600">Détails de facturation</h4>
                    </div>
                    <form method="post" action="{{route('checkout.order')}}" id="checkoutForm">
                        ...
                        <div class="mb-4">
                            <x-input-label for="billing_address" :value="__('Adresse *')" />
                        ...
                        <div class="mb-4">
                            <x-input-label for="state" :value="__('État / Région *')" />
                        ...
                        <div class="form-group mb-30">
                            <x-input-label for="order_notes" :value="__('Informations supplémentaires')" />
                            <x-text-input id="order_notes" name="order_notes" type="text" class="mt-1 block w-full"
                                autofocus autocomplete="order_notes" placeholder="Des notes ?" value="{{$billingDetails ? $billingDetails->order_notes : ''}}"/>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-md-6">
                    <div class="order_review border-0">
                        <div class="mb-5">
                            <h3 class="my-2 text-lg font-semibold text-gray-600">Votre commande</h3>
                        </div>
