                ...
                <div class="col-lg-9">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p> Nous avons trouvé <strong class="text-brand">{{ $products->total() }}</strong> articles pour vous !</p>
                        </div>
                            ...
                            <div class="sort-by-cover">
                                ...
                                <div class="sort-by-dropdown">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="{{ $sort === 'low-to-high' ? 'active' : '' }}"
                                        ...
                                        <li>
                                            <a class="{{ $sort === 'high-to-low' ? 'active' : '' }}"
                                        ...
                                        <li>
                                            <a href="{{ route('home') }}">Tri par défaut</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="product-cart-wrap mb-30 border-slate-200 shadow-md">
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('product.details', $p->id) }}" class="aspect-[5/4] w-full overflow-hidden rounded-lg">
                                                <img class="default-img  w-full h-full object-cover" src="{{ $p->image }}" alt="{{ $p->name }}">
                                            </a>
                                        </div>
                                    </div>

                                    <div class="product-content-wrap border">
                                        ...
                                        <h2>
                                            <a href="{{ route('product.details', $p->id) }}" class="text-xl">
